...
public class Settings {
    ...
    public static final float SAMBA_VELOCITY = 50;
    ...
    public static final float MIN_MASCARA = 0.5f;

    // Configuració scrollable
    public static final int MASCARA_SPEED = -150;
    public static final int MASCARA_GAP = 75;
    public static final int BG_SPEED = 0;
